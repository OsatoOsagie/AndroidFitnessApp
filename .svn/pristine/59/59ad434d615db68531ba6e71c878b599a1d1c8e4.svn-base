...
public class Getting_startedFragment extends Fragment {
    ...
    private String[] description = {"Allows users to see workouts within the application Workout", "Allows users to add their Weight", "Allows users to add measurements for each body part", "Allows users to create a profile", "Allows users to calculate macro nutrients"};
