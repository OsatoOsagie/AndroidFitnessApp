 ...
 * This class loads up the registration fragment where a user is able to register to the application
 */
...
//        //linking the variables defined above to the widgets in the XML
        ...
        String signUpHint = "Already have an account?";
        String signUp_txt = "Sign in here";
        builderSignIn.append(signUpHint);
        builderSignIn.append(" ");
        builderSignIn.append(colour_txt(signUp_txt));

        textViewSignInLink.setText(builderSignIn);
    ...
    /*
    Validates a users details then makes a request to the server
     */
    private void onReg() {
        ...
        } else if (!fNameEt.getText().toString().matches("^[A-Za-z]+$") || !lName.getText().toString().matches("^[A-Za-z]+$")) {
            fNameEt.setError("Please enter a valid  first name");
            fNameEt.requestFocus();
            ...
            call.enqueue(new Callback<RegistrationResponse>() {
                ...
                public void onResponse(Call<RegistrationResponse> call, Response<RegistrationResponse> response) {
                    if (response.body().getResponse().equals("ok")) {
                        ...
                        prefConFig.writeUser_password(passwordET.getText().toString());
