...
public class Exercises_LVAdapter extends ArrayAdapter<String> implements View.OnClickListener, Filterable {
    ...
    Exercises_LVAdapter(Activity context, ArrayList<String> exercise, ArrayList<Integer> image, ArrayList<String> image_url, ArrayList<String> favourites, ArrayList<String> exercise_Id, ArrayList<String> custom_plan) {
